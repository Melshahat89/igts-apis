    ...
    public function quickLinks(){
        return response(apiReturn([
                ...
                [
                    ...
                    'image' => 'https://igtsservice.com/uploads/files/medium/1.webp',
                ],
                [
                    'name' => 'Verify',
                    'title' => 'certificate',
                    'link' => 'https://igtsservice.com/ar/verifycertificate',
                    'image' => 'https://igtsservice.com/uploads/files/medium//2.webp',
                ],
                [
                    'name' => 'IGTS',
                    'title' => 'business',
                    'link' => 'https://igtsservice.com/ar/business',
                    'image' => 'https://igtsservice.com/uploads/files/medium/3.webp',
                ],
                [
                    'name' => 'F&Q',
                    'title' => '',
                    'link' => 'https://igtsservice.com/ar/faq',
                    'image' => 'https://igtsservice.com/uploads/files/medium/4.webp',
                ],
                [
                    'name' => 'Our',
                    'title' => 'instructors',
                    'link' => 'https://igtsservice.com/ar/instructors/All',
                    'image' => 'https://igtsservice.com/uploads/files/medium//5.webp',
                ],
                [
                    'name' => 'Join',
                    'title' => 'as instructor',
                    'link' => 'https://igtsservice.com/ar/joinAsInstructor',
                    'image' => 'https://igtsservice.com/uploads/files/medium/6.webp',
                ],
                [
                    'name' => 'IGTS',
                    'title' => 'blog',
                    'link' => 'https://igtsservice.com/ar/blog',
                    'image' => 'https://igtsservice.com/uploads/files/medium/7.webp',
                ],
