...
@section('content')
    ...
    @include(layoutMessage())
        <form action="{{ concatenateLangToUrl('lazyadmin/setting/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                    <div class="">
                        <label for="status">{{ trans('setting.Status') }}</label>
