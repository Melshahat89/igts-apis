...
@section('content')
    <form action="{{ concatenateLangToUrl('lazyadmin/export') }}" method="post">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-3">
    ...
    <form action="{{ concatenateLangToUrl('lazyadmin/import') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
