...
@section('content')
    <form action="{{ concatenateLangToUrl('lazyadmin/command/exe') }}" method="post">
        {{ csrf_field() }}
    ...
    <form action="{{ concatenateLangToUrl('lazyadmin/laravel/haveCommand') }}" method="post" id="otherForm" style="display: none">
        {{ csrf_field() }}
        <div class="form-group">
            <div class="">
