@include('website.theme.bootstrap.layout.igts.shared.innerPagesHead', ['title' => $headTitle]) 
    ...
    <div class="wrapper">
        ...
        <div class="component_main">
            <aside class="component_aside aside_sm" data-sticky="nav" data-plugin-option="{&quot;offset_top&quot;:80}">
                <div class="ptmd pbmd prmd plmd b_all" style="border: none;">
            ...
            <div tag id="categoryList" class="list-view">
                    <div class="course_card_list">
                        ...
                        <!-- START FILTERING DIV -->
                            ...
                            {{-- @include('website.categories.assets.filters-container', ['talks' => false, 'events' => true]) --}}
                        ...
                        <div class="{{ (count($items) < 1) ? 'col-12' : 'col-md-9' }}">
                            @foreach($items as $item)
                                    ...
                                    @include('website.events.assets.eventCardList', ['data' => $item]) 
