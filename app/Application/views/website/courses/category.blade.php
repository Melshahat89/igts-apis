...
@push('js')
<script src="{{ asset('public/old') }}/js/front/social.js"></script>
@endpush
  @section('content')
  ...
  <main class="main_content">
    ...
    @include('website.courses.assets.coursesPerCategory', ['items' => $Courses, 'headTitle' => trans('home.courses'), 'duration' => $duration, 'rating' => $rating]) 
