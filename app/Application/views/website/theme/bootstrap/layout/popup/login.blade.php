                ...
                {{ csrf_field() }}
                    ...
                    <div class="form_row">
                        <div class="input_with_icon">
                            ...
                            <input id="email-login" type="email" class="form-control input-item email-login-ico" name="email" value="{{ old('email') }}" class = 'form-control input-item user-login-ico' label = 'Username' placeholder = '{{trans('account.email')}}' required >
                    ...
                    <div class="form_row">
                        <div class="input_with_icon">
                            ...
                            <input id="password-login" autocomplete="" type="password" class="form-control input-item password-login-ico" name="password" value="{{ old('password') }}" class = 'form-control input-item user-login-ico' label = 'Username' placeholder = '{{trans('account.password')}}' required >
