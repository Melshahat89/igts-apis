...
<div class="content">
    ...
    .content {
        ...
        width:100%;
        height:100%;
        background:transparent url('https://igtsservice.com/certificate.jpg') no-repeat 0 0;
    ...
    <div class="content_text">
        <p style="position: absolute; left: 0; right: 0; font-family: 'Beau Rivage', cursive; font-size: 66px; top: 350px; color: #244092;"><?php echo $name; ?></p>
        ...
        <p style="position: absolute; left: 410px; bottom: -265px;">{{Carbon::now()->format('Y-m-d')}}</p>
        <p style="position: absolute; right: 400px; bottom: -250px;font-family: 'Beau Rivage', cursive;font-size: 25px;">Ahmed Sabah</p>
    </div>
    @if(isset($certificateId))
    <img src="https://igtsservice.com/igts-verify-certificate-qr.png" style="position: absolute;height: 90px;top: 665px;left: 860px;">
